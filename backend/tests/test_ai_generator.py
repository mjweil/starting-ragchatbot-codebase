...
class TestAIGenerator:
    ...
    def test_handle_tool_execution_multiple_tools(self, mock_anthropic_class):
        ...
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="test query 1")
    ...
    def test_sequential_tool_calling_two_rounds(self, mock_anthropic_class):
        ...
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="lesson 4", course_name="MCP")
